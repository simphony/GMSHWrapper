    ...
    def test_run_session(self):
        with TemporaryDirectory() as temp_dir:
            ...
            for binding_set in result(x_elements_value='cuds',
                ...
                self.assertEqual(binding_set["x_elements_value"].hasNumericalData, 74)
                self.assertEqual(binding_set["y_elements_value"].hasNumericalData, 93)
                self.assertEqual(binding_set["z_elements_value"].hasNumericalData, 15)
